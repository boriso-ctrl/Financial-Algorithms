...
# Set your API key and data directory
sf.set_api_key('985f143a-6709-4578-b2ee-4d5eaac01330')
sf.set_data_dir('C:/Users/boris/.simfin')  # will be created if missing

# Define market and load daily share prices
market = 'us'
df_prices = sf.load_shareprices(variant='daily', market=market)

# Load S&P500 tickers from local CSV
sp500_csv_path = "sp500.csv"

def obtain_sp500_tickers(csv_path):
    """
    Load S&P500 tickers from local CSV.
...
tickers = obtain_sp500_tickers(sp500_csv_path)

# Example: reference stock
ref = 'AAPL'
# tickers = [ref] + tickers[:3]  # optional subset for testing

# Select daily prices for these tickers
df_prices_daily = df_prices.loc[tickers].copy()

# Example: initialize list for symbols
symbols = []
